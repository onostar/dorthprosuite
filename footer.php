<footer>
        <section class="mainFooter">
            <section class="mainFooter1">
                ...
                <div class="subscribe_category" style="display:none">
                   <!--  <section id="map">
...
<!-- </div> -->
    ...
    <div class="toTop">
        <a href="#banner"><i class="fas fa-chevron-up" style="color:#fff;"></i></a>
    </div>
    <div id="whatsapp_link">
        <a href="https://wa.me/+2347068897068" title="Chat with us" target="_blank"><i class="fab fa-whatsapp"></i></a>
    </div>
    <!-- addvert -->
    <!-- <div class="addverts">
        <div class="close_add">
