window.onscroll = function(){changeHeader(), displayTotopButton(), displayFeatures(),showServices(), displayAbout(),  displayPartners(), displaytestimony() /*showRecentWork(), displayCallToAction() */};
...
function displayTotopButton(){
    if(document.body.scrollTop > 70 || document.documentElement.scrollTop > 70){
        ...
        document.getElementById('whatsapp_link').style.display = 'block';
    }
    else{
        document.querySelector('.toTop').style.display = 'none';
        document.getElementById('whatsapp_link').style.display = 'none';
    }
}
