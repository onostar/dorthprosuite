<?php
    ...
    <div class="add_user_form priceForm" style="width:90%; padding:0!important">
        ...
        <h3 style="background:var(--tertiaryColor);">Sell pack for <?php echo strtoupper($name)?></h3>
            <div class="inputs" style="justify-content:left">
                ...
                <div class="data" style="width:auto">
                    <button type="submit" id="change_price" name="change_price" onclick="sellPack('sell_pack.php')">Update </button>
