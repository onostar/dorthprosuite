<?php
    ...
    ?>
    <div class="add_user_form priceForm" style="width:80%; margin:5px auto;">
        ...
        <section style="text-align:left; width:100%;margin:0">
            <div class="inputs" style="gap:0.4rem; justify-content:left">
