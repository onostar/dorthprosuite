...
?>
<h2>Most Sold Items between '<?php echo date("jS M, Y", strtotime($from)) . "' and '" . date("jS M, Y", strtotime($to))?>' (Quantity)</h2>
    <hr>
    <div class="search">
    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_2dateGroMany1c('sales', 'item', 'quantity', 'total_amount', 'date(post_date)', 'sales_status', 2, 'store', $store, 'item', 'SUM(quantity)', $from, $to);
