...
<div class="all_modes">
    ...
    $trfs = $get_transfer->fetch_sum_2date2Cond('payments', 'amount_due', 'date(post_date)', 'payment_mode', 'store', $from, $to, 'Transfer', $store);
    ...
    $amounts = $get_total->fetch_sum_2date2Cond('sales', 'total_amount', 'date(post_date)','store', 'sales_status', $from, $to, $store, 2);
