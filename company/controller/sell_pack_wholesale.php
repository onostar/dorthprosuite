<?php   
        ...
        $unit_price = $get_price->fetch_details_group('items', 'wholesale_pack', 'item_id', $item_id);
        $old_price = $unit_price->wholesale_pack;
        ...
        if($total_qty > $inv_qty){
            ...
            if($cost_price > $pack_price){
                ...
                $update->update_multiple('sales', 'quantity', $total_qty, 'price', $pack_price, 'total_amount', $new_amount, 'discount', $discount, 'cost', $total_cost, 'sales_id', $sales);
