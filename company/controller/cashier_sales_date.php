...
?>
<div id="revenueReport" class="displays" style="margin:0!important">
<div class="displays allResults new_data" id="revenue_report">
    <h2>Sales made by <?php echo $cashier_name?> between <?php echo date("d-M-Y",strtotime($from))?> and <?php echo date("d-M-Y",strtotime($to))?></h2>
    <hr>
    <div class="search">
    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_users->fetch_details_2date2Con('sales', 'date(post_date)', $from, $to, 'sales_status', 2, 'posted_by', $cashier);
    ...
    <?php
        ...
        $cashs = $get_cash->fetch_sum_2date2Cond('payments', 'amount_paid', 'date(post_date)', 'payment_mode', 'posted_by',$from, $to, 'Cash',  $cashier);
        ...
        //get pos
        $get_pos = new selects();
        $poss = $get_pos->fetch_sum_2date2Cond('payments', 'amount_paid', 'date(post_date)', 'payment_mode', 'posted_by',$from, $to, 'POS',  $cashier);
        ...
        $trfs = $get_transfer->fetch_sum_2date2Cond('payments', 'amount_paid', 'date(post_date)', 'payment_mode', 'posted_by',$from, $to, 'Transfer',  $cashier);
        ...
        $amounts = $get_total->fetch_sum_2dateCond('payments', 'amount_paid', 'posted_by','date(post_date)', $from, $to, $cashier);
