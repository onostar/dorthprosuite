        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="color:red;font-size:.8rem">
                    ...
                    <a style="color:#fff; background:green;border-radius:5px;padding:5px 8px;" href="javascript:void(0)" title="increase quantity" onclick="increaseQtyOrder('<?php echo $detail->sales_id?>', '<?php echo $detail->item?>')"><i class="fas fa-arrow-up"></i></a>
                    <a style="color:#fff; background:var(--primaryColor);border-radius:5px;padding:5px 8px;" href="javascript:void(0)" title="decrease quantity" onclick="reduceQtyOrder('<?php echo $detail->sales_id?>')"><i class="fas fa-arrow-down"></i></a>
                    <a style="color:#fff; background:var(--otherColor);border-radius:5px;padding:5px 8px;" href="javascript:void(0)" title="show more options" onclick="showMoreOrder('<?php echo $detail->sales_id?>')"><i class="fas fa-pen"></i></a>
                    <a style="color:#fff; background:var(--secondaryColor);border-radius:5px;padding:5px 8px;" href="javascript:void(0)" title="sell item in pack" onclick="getPackSo('<?php echo $detail->sales_id?>')"><i class="fas fa-box"></i></a>
                </td>
                <td>
                    <?php 
