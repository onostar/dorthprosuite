...
?>
            <tr>
                ...
                <td style="color:var(--otherColor)">
                    ...
                    ?>
                    <a href="javascript:void(0)" style="color:var(--otherColor)" onclick="showPage('../controller/cashier_sales_date.php?cashier=<?php echo $detail->posted_by?>&from=<?php echo $from?>&to=<?php echo $to?>')">
                    <?php echo $cashier?></a>  
                </td>
                <td>
                    <?php
