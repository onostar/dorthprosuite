...
<div class="customer_info" class="allResults">
    ...
    <!-- <h3 style="background:var(--tertiaryColor); text-align:center; color:#fff; padding:10px;margin:0;">Transactions</h3> -->
    <div class="transactions">
        <div class="all_credit allResults">
            ...
            <?php
                ...
                $amounts = $get_total->fetch_sum_2date2Cond('sales', 'total_amount', 'date(post_date)', 'customer', 'sales_status', $from, $to, $customer, 2);
        ...
        <div class="all_credit allResults" id="cust_credits">
