...
<div class="displays all_details">
    ...
    <!-- <div class="info"></div> -->
    <button class="page_navs" id="back" onclick="showPage('wholesale_report.php')"><i class="fas fa-angle-double-left"></i> Back</button>
    <?php }else{?>
    <button class="page_navs" id="back" onclick="showPage('retail_sales.php')"><i class="fas fa-angle-double-left"></i> Back</button>
    <?php }?>
