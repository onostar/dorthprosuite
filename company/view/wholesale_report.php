<?php
    ...
    if($package == 3){
?>
<div id="revenueReport" class="displays" style="margin:0!important; width:100%!important">
    ...
    <table id="data_table" class="searchTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a style="color:green" href="javascript:void(0)" title="View invoice details" onclick="showPage('invoice_details.php?payment_id=<?php echo $detail->payment_id?>&type=wholesale')"><?php echo $detail->invoice?></a></td>
