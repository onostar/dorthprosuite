...
<div class="displays all_details">
    ...
    <div class="guest_name">
        <div class="displays allResults" id="payment_det">
            ...
            <div class="payment_details" style="width:70%; margin:0">
            ...
            <section class="addUserForm">
                <div class="inputs" style="display:flex; flex-wrap:wrap;align-items:flex-end">
                    ...
                    <div class="data">
                        <button onclick="postSalesOrder()" style="background:green; padding:8px; border-radius:15px;font-size:.9rem; margin:10px">Post and Print <i class="fas fa-print"></i></button>
                    </div>
                </div>
            </section>
        </div>
