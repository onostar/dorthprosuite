            ...
            <a href="javascript:void(0)" class="page_navs">
                <div class="infos">
                    ...
                    <?php
                        //get total customers
                       $get_cus = new selects();
                       $customers =  $get_cus->fetch_count_3condDateGro('sales', 'sales_status', 2, 'posted_by', $user_id, 'store', $store_id, 'post_date', 'invoice');
                       echo $customers;
                    ?>
                    </p>
                </div>
        ...
        <table id="check_out_table" class="searchTable" style="width:100%;">
            ...
            <tbody>
                <?php
                    ...
                    $details = $get_users->fetch_details_date2Cond('sales', 'date(post_date)', 'sales_status', 2, 'posted_by', $user_id, 'store', $store_id);
