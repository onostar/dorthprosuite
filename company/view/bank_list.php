...
?>
    <div class="info"></div>
<div class="displays allResults" id="room_list" style="width:80%!important; margin:10px 50px!important;">
    ...
    <table id="bank_list_table" class="searchTable">
        ...
        <tbody>
            <?php
                ...
                $details = $get_details->fetch_details_orderCond('banks', 'company', $company, 'bank');
