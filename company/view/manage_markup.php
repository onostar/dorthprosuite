                ...
                <div class="add_user_form" style="width:50%; margin:10px 0; box-shadow:none">
                    ...
                    <div class="inputs">
                        ...
                        <div class="data" id="bar_items" style="width:100%; margin:2px 0">
                            ...
                            <input type="text" name="item" id="item" required placeholder="Search item name or barcode" onkeyup="checkOtherItems(this.value, getItemDetails, 'get_markup.php')" autofocus>
                            <div id="sales_item">
