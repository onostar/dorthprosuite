...
?>
<div id="printReceipt" class="displays" style="margin:0!important; width:100%!important">
    ...
    <table id="revenue_table" class="searchTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><button style="box-shadow:1px 1px 1px #222;border-radius:10px; background:#c4c4c4; color:#000; padding:5px;border:1px solid #fff; margin:0!important" title="Print receipt" onclick="printReceipt('<?php echo $detail->invoice?>');"><i class="fas fa-print"></i> Print</button></td>
            </tr>
            <?php $n++; endforeach;}?>
        </tbody>
    </table>
