...
<div id="sales_form" class="displays all_details">
    ...
    <div class="add_user_form" style="width:50%; margin:10px 0; box-shadow:none">
        <h3 style="background:var(--primaryColor); color:#fff; text-align:left!important;" >Delete item</h3>
            ...
            <section class="addUserForm">
                <div class="inputs">
                    ...
                    <div class="data" id="bar_items" style="width:100%; margin:2px 0">
                        ...
                        <input type="text" name="item" id="item" autofocus placeholder="Input item name or barcode" onkeyup="getItemDelete(this.value)">
                        <div id="sales_item">
