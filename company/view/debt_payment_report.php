...
?>
<div id="debt_paymentReport" class="displays" style="margin:0!important;width:100%!important">
...
<div class="displays allResults new_data" id="revenue_report">
    ...
    <div class="search">
        ...
        <a class="download_excel" href="javascript:void(0)" onclick="convertToExcel('data_table', 'Debtors payment report')"title="Download to excel"><i class="fas fa-file-excel"></i></a>
    </div>
