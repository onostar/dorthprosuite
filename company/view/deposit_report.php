<?php
    ...
    if($package == 3){
?>
<div id="debt_paymentReport" class="displays" style="width:100%!important">
...
<div class="displays allResults new_data" id="revenue_report">
    ...
    <?php
        ...
        if(gettype($cashs) === "array"){
            ...
            ?>
                <p class="sum_amount" style="background:var(--otherColor)"><strong>Cash</strong>: ₦ <?php echo number_format($cash->total, 2)?></p>
        ...
        if(gettype($poss) === "array"){
            foreach($poss as $pos){
                ?>
                <p class="sum_amount" style="background:var(--secondaryColor)"><strong>POS</strong>: ₦ <?php echo number_format($pos->total, 2)?></p>
        ...
        if(gettype($trfs) === "array"){
            foreach($trfs as $trf){
                ?>
                <p class="sum_amount" style="background:var(--primaryColor)"><strong>Transfer</strong>: ₦ <?php echo number_format($trf->total, 2)?></p>
