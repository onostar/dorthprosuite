...
<div id="edit_item_price">
    <div class="add_user_form priceForm" style="width:90%">
        ...
        <section style="text-align:left;">
            <div class="inputs" style="flex-wrap:wrap; gap:.5rem;">
                ...
                <?php if($package == 3 || $user == "Sysadmin"){?>
                <div class="data" style="width:24%">
                ...
                <?php }else{?>
                    <input type="hidden" name="wholesale_price" id="wholesale_price" value="<?php echo $row->wholesale?>" readonly>
                    <input type="hidden" name="wholesale_pack" id="wholesale_pack" value="<?php echo $row->wholesale_pack?>" readonly>
                <?php }?>
