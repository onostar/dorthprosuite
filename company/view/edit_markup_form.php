...
<?php
    ...
    $rows = $get_item->fetch_details_cond('items', 'item_id', $item);
     if(gettype($rows) == 'array'){
        foreach($rows as $row):
?>
    <div class="add_user_form priceForm" style="width:70%; margin:20px 50px">
        ...
        <section class="addUserForm" style="text-align:left;">
            <div class="inputs" style="flex-wrap:wrap; gap:1rem;">
                ...
                <div class="data" style="width:30%">
                    ...
                    <input type="text" name="cost_price" id="cost_price" value="<?php echo $row->cost_price?>" autofocus>
                </div>
                <div class="data" style="width:30%">
