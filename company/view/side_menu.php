<aside class="main_menu" id="mobile_log">
    ...
    <nav>
        ...
        <?php
            }elseif($role == "Admin" && $package_name == "Basic"){
        ...
        <ul>
            <?php 
                //get menus
                $get_Admin_menus = new selects();
                $admin_menus = $get_Admin_menus->fetch_single_groupedCon('sub_menus', 'menu', 'package', 1);
                if(gettype($admin_menus) == "array"){
            ...
            <li>
                ...
                <ul class="subMenu" id="<?php echo $admin_menu_name->menu?>">
                    <?php
                        $get_admin_sub = new selects();
                        $admin_subs = $get_admin_sub->fetch_details_2cond('sub_menus', 'menu','package',  $admin_men->menu, 1);
                        if(gettype($admin_subs) == "array"){
                            foreach($admin_subs as $admin_sub){
                ...
                <?php } }?>
            <li>
                <a href="renew_package.php" target="_blank" title="Update package" class="page_navs"> <i class="fas fa-circle-check"></i> Update Package</a>
            </li>
        </ul>
        <?php
            }elseif($role == "Admin" && $package_name == "Standard"){
        ...
        <ul>
            <?php 
                //get menus
                $get_Admin_menus = new selects();
                $admin_menus = $get_Admin_menus->fetch_single_grouped2Con('sub_menus', 'menu', 'package', 1, 2);
                if(gettype($admin_menus) == "array"){
            ...
            <li>
                ...
                <ul class="subMenu" id="<?php echo $admin_menu_name->menu?>">
                    <?php
                        $get_admin_sub = new selects();
                        $admin_subs = $get_admin_sub->fetch_details_3eithercond('sub_menus', 'menu','package',  $admin_men->menu, 1, 2);
                        if(gettype($admin_subs) == "array"){
                            foreach($admin_subs as $admin_sub){
        ...
        <?php
            }elseif($role == "Admin" && $package_name == "Professional"){
        ...
        <ul>
            <?php 
                //get menus
                $get_Admin_menus = new selects();
                $admin_menus = $get_Admin_menus->fetch_single_grouped3Con('sub_menus', 'menu', 'package', 1, 2, 3);
                if(gettype($admin_menus) == "array"){
            ...
            <li>
                ...
                <ul class="subMenu" id="<?php echo $admin_menu_name->menu?>">
                    <?php
                        $get_admin_sub = new selects();
                        $admin_subs = $get_admin_sub->fetch_details_4eithercond('sub_menus', 'menu','package',  $admin_men->menu, 1, 2, 3);
                        if(gettype($admin_subs) == "array"){
                            foreach($admin_subs as $admin_sub){
