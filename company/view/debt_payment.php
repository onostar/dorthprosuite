<div id="pay_debts" class="displays">
<?php
...
?>
    <div class="top_view">
        ...
        <?php
            //wallet balance
            echo "<p style='color:green;font-size:1rem;'>Wallet Balance: ₦".number_format($balance, 2)."</p>";
                ...
                <div class="payment_details">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a style="color:#fff;background:var(--primaryColor); padding:5px; border-radius:5px" href="javascript:void(0)" title="Pay debt" onclick="payDebt('<?php echo $detail->invoice?>', '<?php echo $customer?>', '<?php echo $balance?>', '<?php echo $invoice_total?>')">Pay <i class="fas fa-hand-holding-usd"></i></a>
                            </td>
                        </tr>
                        <?php $n++; }}?>
                    </tbody>
