        ...
        <section >
            <div class="inputs" style="gap:.5rem;">
                ...
                <div class="data" style="width:auto">
                    ...
                    <a href="javascript:void(0)" onclick="showPage('edit_supplier_info.php')" style="background:brown;padding:10px;border-radius:15px; color:#fff; box-shadow:1px 1px 1px #000;border:1px solid #fff"><i class="fas fa-angle-double-left"></i> Back</a>
                </div>
            </div>
        </section>    
    </div>
