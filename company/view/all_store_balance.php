...
?>
    <div class="info"></div>
<div class="displays allResults" id="bar_items" style="width:90%!important;margin:20px!important">
            ...
            <div class="from_to_date" style="width:40%">
                ...
                <select name="store" id="store" onchange="getStockBalance(this.value)">
                    ...
                    <?php
                        ...
                        $strs = $get_store->fetch_details_cond('stores', 'company', $company);
                        foreach($strs as $str){
                    ?>
    ...
    <div class="store_balance">
        ...
        <div class="search">
            ...
            <a class="download_excel" href="javascript:void(0)" onclick="convertToExcel('data_table', 'Al Stores Stock balance')"title="Download to excel"><i class="fas fa-file-excel"></i></a>
        </div>
        <table id="data_table" class="searchTable">
            ...
            <tbody>
                <?php
                    ...
                    $details = $get_items->fetch_AllStock($company);
